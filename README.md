...
В сборке не реализованна функция минификации файлов.
...
Реализована функция конвертации формата __ttf__ в __woff2__ , реализован миксин `@font-face` автоматически.
